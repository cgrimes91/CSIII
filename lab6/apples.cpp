...
int main(){
   ...
   int cnt= count_if(crate.begin(), crate.end(), [toFind] (Apples a) {return a.weight>toFind;});//count all apples
   ...
   while(it!=crate.end()){//count apples above said weight
     cout<<it->index<<", ";
   ...
   cout << "Heaviest apple weighs: " << std::max_element(crate.begin(), crate.end(), [] (Apples a, Apples b) {return a.weight<b.weight;})->weight << " oz" << endl;//output heavest apple weight
   ...
   cout << "Total apple weight is: " << std::accumulate(crate.begin(), crate.end(), 0,[] (double sum, Apples a){return sum+ a.weight;})  << " oz" << endl;//adds all apples weights
   ...
   std::transform(crate.begin(), crate.end(), toAdd.begin(), crate.begin(),addWeight);//adds toGrow amount to apples weight
   ...
   crate.erase(std::remove_if(crate.begin(), crate.end(), [minAccept] (Apples a) {return a.weight<minAccept;}), crate.end());//erases apples below targert weight("minAccept")
   ...
   std::sort(crate.begin(), crate.end(), [](Apples a, Apples b) {return a.weight<b.weight;});//sorts based on weight
   ...
   std::remove_copy_if(crate.begin(), crate.end(), peck.begin(),redCheck);//moves red apples to peck
   crate.erase(std::remove_if(crate.begin(), crate.end(),greenCheck), crate.end());//removes red apples from crate
   peck.erase(std::remove_if(peck.begin(), peck.end(), redCheck), peck.end());//cleans up empty space in peck
   ...
   for_each(crate.begin(), crate.end(), applesPrint);
   ...
   for_each(peck.begin(), peck.end(), applesPrint);
}
 void applesPrint(Apples a){
     a.print();
   }
...
Apples addWeight(Apples lh, Apples rh){//adds weight to the apple for growing
  lh.weight+=rh.weight;
  return lh;
}

Apples makeApple(){//generates an apples attributes
  Apples a;
